...
def generate_launch_description():
    classes_list_ = ["car", "person", "bicycle"]
    confidence_threshold = 0.5
    batch_size = 1278
    #batch_size = 2981
    verbose_level = 1
    isp_configuration_path = "./isp_configuration_pascalraw.json"
    annotations_folder_path = "/home/rachid/git/datasets/pascalraw/validation/"
